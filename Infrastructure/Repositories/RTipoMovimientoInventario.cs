...
{
    public class RTipoMovimientoInventario : RGeneric<TipoMovimientoInventario>, ITipoMovimientoInventario
    {
        private readonly FarmaciaContext _context;

        public RTipoMovimientoInventario(FarmaciaContext context) : base(context)
        {
            _context = context;
        }
        ...
        {
            var query = _context.TipoDocumentos as IQueryable<TipoMovimientoInventario>;
